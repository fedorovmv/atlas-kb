...
5. Dispatch `memory-reviewer` subagent: it decides proposal/historical/conflict, creates the card using `updateCard` tool or `.ai/memory-tool/bin/memory ingest-spec`, updates conflicts/open-questions if needed.
