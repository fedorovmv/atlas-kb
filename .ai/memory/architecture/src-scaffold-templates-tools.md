...
title: 'Архитектура: Src Scaffold Templates Tools'
status: needs_review
...
## Обзор архитектуры
Архитектура модуля Src Scaffold Templates Tools. Требует ревью — опишите высокоуровневую структуру и границы.
