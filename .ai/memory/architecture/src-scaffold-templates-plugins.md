...
title: 'Архитектура: Src Scaffold Templates Plugins'
status: needs_review
...
## Обзор архитектуры
Архитектура модуля Src Scaffold Templates Plugins. Требует ревью — опишите высокоуровневую структуру и границы.
