...
id: scenario-memory-guard-plugin-plan
title: Memory guard plugin plan
status: needs_review
...
product_areas:
  - docs
  - plans
  - memory-guard-plugin-plan.md
source_refs:
  - path: docs/plans/memory-guard-plugin-plan.md
    role: current_doc
usage_policy:
