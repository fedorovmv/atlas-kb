---
entity_type: module
id: src-scaffold-templates-tools
title: Src Scaffold Templates Tools
status: needs_review
...
product_areas:
  ...
  - templates
code_refs:
  - path: src/scaffold/templates/tools/memory.ts
    kind: production
test_refs: []
source_refs:
...
- Code file at src/scaffold/templates/tools/memory.ts:1
