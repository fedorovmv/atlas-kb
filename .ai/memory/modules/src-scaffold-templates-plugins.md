---
entity_type: module
id: src-scaffold-templates-plugins
title: Src Scaffold Templates Plugins
status: needs_review
...
product_areas:
  ...
  - templates
code_refs:
  - path: src/scaffold/templates/plugins/memory-guard.js
    kind: production
test_refs: []
source_refs:
...
# Src Scaffold Templates Plugins
...
- Code file at src/scaffold/templates/plugins/memory-guard.js:1
